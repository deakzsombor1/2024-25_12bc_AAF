...
namespace _2024_12_18_Beepitett_fuggvenyek
{
    internal class Program
    {
        ...
        private static void SzovegesBeepitettFuggvenyek()
        {
            ...
            // Substring(mettől, meddig) - Kiveszi a szövegből az indexszelés és mennyiséggel megadott karaktereket.
            ...
            // ToCharArray Szövegből karaktertömböt készít
            char[] ct = sz.ToCharArray();
            ct[0] = 'g';
            Console.WriteLine(ct);

            string[] szamok = new string[] { "1", "2", "3", "4" };
