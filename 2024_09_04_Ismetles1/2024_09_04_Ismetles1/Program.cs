...
namespace _2024_09_04_Ismetles1
{
    internal class Program
    {
        /* Ismétlés
             ...
             * (1,2,3,5,6,7,9,10,11...)
             * Írj alkalmazást, ami kigenerál mindkettőjüknek 10-10 dobást!
             * Adja meg, hogy ki dobta a legtöbbször a legnagyobb számot!*/

            /* Írj egy fv-t, ami egy számról eldönti, hogy prím-e! */
        ...
        {
            Console.WriteLine("a dobott számok között {0} prím van.", DarabPrimek());
        }
